...
public class PracticeQuestion4_UsingMethods {
	...
	public static void main(String[] args) {
		...
		countOfValuesInarrayList(list, size);

		scanner.close();
	}

	public static void countOfValuesInarrayList(ArrayList<Integer> list, int size ) {
